 ...
 */
#ifndef VENDOR_EDIT
/*Mark.Yao@PSW.MM.Display.Lcd.Stability, 2018-05-31,add for  export drm_notifier*/
...
#ifdef VENDOR_EDIT
/*Mark.Yao@PSW.MM.Display.Lcd.Stability, 2018-05-31,add for  remove original drm notify*/
